...
const FooterCompanyInfo = () => {
  ...
  return (
    <div className="col-span-2 md:col-span-1">
      <h3 className="text-2xl font-serif font-bold text-[#4e342e] mb-4 tracking-wider">
        VENICE WOOD LTD
      </h3>
      <p className="text-gray-600 mb-3">{settings.footerText}</p>
      <div className="flex space-x-4">
        {settings.facebookUrl && (
          <a
            ...
            className="text-gray-500 hover:text-[#4e342e] transition duration-300"
            aria-label="Facebook"
          >
